...
[![Bootstrap](https://img.shields.io/badge/Bootstrap-5.3+-purple.svg)](https://getbootstrap.com/)[![Bootstrap](https://img.shields.io/badge/Bootstrap-5.3+-purple.svg)](https://getbootstrap.com/)

[![Theme](https://img.shields.io/badge/Theme-Dark%20%2F%20Light-00ADB5.svg)](#features)[![Theme](https://img.shields.io/badge/Theme-Dark%20%2F%20Light-00ADB5.svg)](#features)



[Live Demo](https://xttrust.github.io/Vectra-UI-KIT/) · [Components](#component-library) · [Documentation](docs.html) · [Report Bug](https://github.com/xttrust/Vectra-UI-KIT/issues)[Live Demo](https://xttrust.github.io/Vectra-UI-KIT/)  [Components](#component-library)  [Documentation](docs.html)  [Report Bug](https://github.com/xttrust/Vectra-UI-KIT/issues)
...
![Home Hero Dark](docs/img/home-hero-dark.png)![Home Hero Dark](docs/img/home-hero-dark.png)



*Sleek dark theme with vibrant teal/cyan accents**Sleek dark theme with vibrant teal/cyan accents*
...
![Home Hero Light](docs/img/home-hero.png)![Home Hero Light](docs/img/home-hero.png)



*Clean light theme with premium slate tones**Clean light theme with premium slate tones*
...
![Components Catalog](docs/img/components-catalog-dark.png)![Components Catalog](docs/img/components-catalog-dark.png)



*50+ production-ready components**50+ production-ready components*



![Core Components](docs/img/core-components-dark.png)![Core Components](docs/img/core-components-dark.png)



*Cards, forms, buttons, and more**Cards, forms, buttons, and more*
...
- **🎨 Dual Theme System** - Beautiful dark & light modes with smooth transitions- ** Dual Theme System** - Beautiful dark & light modes with smooth transitions

- **⚡ Zero Build Required** - Pure HTML, CSS, and vanilla JavaScript- ** Zero Build Required** - Pure HTML, CSS, and vanilla JavaScript

- **📦 50+ Components** - Production-ready UI primitives and complex patterns- ** 50+ Components** - Production-ready UI primitives and complex patterns

- **🎭 Design Tokens** - CSS variables for easy customization- ** Design Tokens** - CSS variables for easy customization

- **♿ Accessibility First** - WCAG compliant with semantic HTML and ARIA labels- ** Accessibility First** - WCAG compliant with semantic HTML and ARIA labels

- **📱 Fully Responsive** - Mobile-first design that works everywhere- ** Fully Responsive** - Mobile-first design that works everywhere

- **🚀 Bootstrap 5.3+ Powered** - Built on the world's most popular framework- ** Bootstrap 5.3+ Powered** - Built on the world's most popular framework

- **🎪 Rich Animations** - AOS (Animate On Scroll) integration- ** Rich Animations** - AOS (Animate On Scroll) integration

- **💼 Production Ready** - Used in real-world SaaS applications- ** Production Ready** - Used in real-world SaaS applications
...
- **CSS3** - Modern features (Grid, Flexbox, Custom Properties)- **CSS3** - Modern features (Grid, Flexbox, Custom Properties)

- **Bootstrap 5.3+** - Component framework- **Bootstrap 5.3+** - Component framework

- **Font Awesome 6+** - Icon library- **Font Awesome 6+** - Icon library

- **AOS** - Scroll animations- **AOS** - Scroll animations

- **Vanilla JavaScript** - No framework dependencies- **Vanilla JavaScript** - No framework dependencies
...
git clone https://github.com/xttrust/Vectra-UI-KIT.gitgit clone https://github.com/xttrust/Vectra-UI-KIT.git

cd Vectra-UI-KITcd Vectra-UI-KIT

``````



Open `index.html` in your browser - that's it! No build process required.Open `index.html` in your browser - that's it! No build process required.
...
[Download the latest release](https://github.com/xttrust/Vectra-UI-KIT/archive/refs/heads/main.zip) and extract it.[Download the latest release](https://github.com/xttrust/Vectra-UI-KIT/archive/refs/heads/main.zip) and extract it.



### Option 3: Use Individual Components### Option 3: Use Individual Components



Copy/paste component blocks from:Copy/paste component blocks from:



- `components.html` - UI primitives and complex components- `components.html` - UI primitives and complex components

- `sections.html` - Marketing and landing sections- `sections.html` - Marketing and landing sections

- `forms.html` - Auth, contact, and multi-step form patterns- `forms.html` - Auth, contact, and multi-step form patterns

- `pricing.html` - Pricing tables and plan displays- `pricing.html` - Pricing tables and plan displays
